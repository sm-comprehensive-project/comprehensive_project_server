...
@Document(indexName = "damoa.kakao_product")
public class KakaoProductDocument {
    @Id
    private String id;
    ...
    // 기본 생성자
    public KakaoProductDocument() {
    }
    
    // 모든 필드를 포함한 생성자
    public KakaoProductDocument(String id, String liveId, Boolean isLive, Date lastUpdated, 
